...
module.exports = {
  async onMessage(ctx) {
    ...
    const audios = [
      ...
      { triggers: ['abrigate'], file: 'abrigate.mp3' },
      { triggers: ['bot'], file: 'bot.mp3' },
      { triggers: ['Aura','aura'], file: 'aura.mp3' },
      { triggers: ['siu','siuu','siuuu','siuuuu','siuuuuu','siuuuuuu'], file: 'siu.mp3' },
      { triggers: ['casa','Casa','choza'], file: 'casa.mp3' },
      { triggers: ['culo','firma','Firma','Culo'], file: 'firma.mp3' },
      { triggers: ['noche'], file: 'Noche.mp3' },
      { triggers: ['sexo'], file: 'S3x0g.mp3' },
      { triggers: ['linda'], file: 'Linda.mp3' },
      { triggers: ['alok','Alok'], file: 'Alok.mp3' },
      { triggers: ['importa'], file: 'no-me-importa.mp3' },
      { triggers: ['piropo'], file: 'piropo.mp3' },
      { triggers: ['buenos'], file: 'buenos.mp3' },
      { triggers: ['homero','mmm','Mmm'], file: 'homero.mp3' },
      { triggers: ['plata','Plata','money'], file: 'plata.mp3' },
      { triggers: ['goku','Goku'], file: 'goku.mp3' },

      // 🔥 FRASES
      { triggers: ['tu no mete'], file: 'Tu no mete.mp3' },
      { triggers: ['Rockstar'], file: 'Rockstar.mp3' },
      { triggers: ['telepatia','telepatía'], file: 'Telepatía.mp3' },
      { triggers: ['elmo','elmoooo'], file: 'elmo.mp3' },
